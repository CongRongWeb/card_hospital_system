    ...
    <div>
      <el-row :gutter="0">
        <el-form ref="elForm2" :model="formData2"  label-width="85px" size="small">
          ...
          <el-col :span="24">
            <el-form-item size="large">
              <el-button type="primary" size="small" plain @click="addUser">添加护士</el-button>
            </el-form-item>
          </el-col>
        </el-form>
      </el-row>
...
<script>
import {delNurse, getNurse, insertNurseOrUpdate,getSectionList} from "../../api/index"
export default {
  name: "index",
  data() {
    return {
...
//处理切换页码
    ...
    addFn() {
      this.$refs['elForm'].validate(valid => {
        if (!valid) return
        insertNurseOrUpdate(this.formData).then(res=>{
          if(res.flag){
            this.$nextTick(()=>{
